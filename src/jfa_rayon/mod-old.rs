...
fn jfa_step_parallel(
    ...
    //par_bridge() converts the iterator into a parallel iterator that Rayon can process
    //chunks_mut(reso) divides the 1D grid into mutable chunks, each representing a row
